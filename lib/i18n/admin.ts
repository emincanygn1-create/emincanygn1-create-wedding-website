...
const tr = {
  ...
  story: {
    title: "Hikayemiz",
    intro:
      "Tanışmanızdan bugüne birkaç durak yazın. Sırayı okla değiştirin, istemediğinizi gizleyin. Ana sayfada ilk üçü görünür, tamamı ayrı sayfada okunur.",
    add: "Yeni Bölüm Ekle",
    photo: "Fotoğraf",
    dateText: "Tarih (yazı olarak, örn. Bahar 2019)",
    postTitle: "Başlık",
    body: "Metin",
    untitled: "(başlıksız)",
    empty: "Henüz bir bölüm eklenmedi.",
  },
  faq: {
    title: "Sıkça Sorulan Sorular",
    intro:
      "Misafirlerin en çok sorduğu şeyleri buraya yazın: kıyafet, ulaşım, çocuklar, park yeri...",
    add: "Yeni Soru Ekle",
    question: "Soru",
    answer: "Cevap",
    unanswered: "(soru yazılmadı)",
...
const it: AdminDict = {
  ...
  story: {
    ...
    intro:
      "Scrivete alcune tappe, dal vostro incontro a oggi. Cambiate l'ordine con le frecce, nascondete ciò che non volete. In home page appaiono le prime tre, il resto si legge in una pagina dedicata.",
    add: "Aggiungi una Tappa",
    photo: "Foto",
    dateText: "Data (in lettere, es. Primavera 2019)",
    postTitle: "Titolo",
    body: "Testo",
    untitled: "(senza titolo)",
    empty: "Non è ancora stata aggiunta nessuna tappa.",
  },
  faq: {
    title: "Domande Frequenti",
    intro:
      "Scrivete qui le domande più comuni degli ospiti: abbigliamento, come arrivare, bambini, parcheggio...",
    add: "Aggiungi una Domanda",
    question: "Domanda",
    answer: "Risposta",
    unanswered: "(domanda non scritta)",
